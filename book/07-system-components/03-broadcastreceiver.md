...
- 参考并改写自：Harun Wangereka，《Mastering Kotlin for Android 14》(2024)，第 8 章与工程实践相关章节。
- 参考并改写自：Gabriel Socorro，《Thriving in Android Development Using Kotlin》(2024)，事件驱动与画中画控制示例。
