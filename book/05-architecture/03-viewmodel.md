...
1. 概念理解题：为什么 ViewModel 解决的核心问题不是“对象活得更久”，而是“页面状态由谁稳定持有”？
2. 编码实现题：把一个原本写在 Activity 或 Fragment 里的页面状态收回 ViewModel，并补上一个最小的状态恢复方案。
3. 拓展思考题：哪些东西不应该进 ViewModel，例如导航、`Context`、视图对象或临时动画状态？你会怎样判断边界？
